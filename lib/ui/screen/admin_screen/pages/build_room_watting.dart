...
class BuildRoomWatting extends StatefulWidget {
  Room room;
  int back;

  BuildRoomWatting(this.room, this.back);

  @override
  _BuildRoomWattingState createState() => _BuildRoomWattingState();
}

class _BuildRoomWattingState extends State<BuildRoomWatting> {
  int _currentImg = 0;
